...
export default function CreateChildProfile() {
	return (
		<div className="relative flex flex-col w-screen min-h-screen bg-retro_blue-100 overflow-hidden">
			<NavHeader backLink />
			<div className="relative flex justify-center flex-1 overflow-hidden sm:items-center px-4 pt-16 lg:py-32">
				<div className="relative z-50 bg-white rounded-3xl w-full shadow-[0px_12px_0px] shadow-retro_blue-400 h-fit flex flex-col px-4 py-12 gap-9 max-w-[408px] self-start lg:max-w-[533px] lg:px-8">
