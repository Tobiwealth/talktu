...
export default function CreateChildProfile() {
	...
	const onSubmit = handleSubmit(async(data) => {
        ...
        try {
            ...
            await addChild({fullName:response?.data.fullName, nickname:response?.data?.nickname,childId:response?.data?._id, childrenId:response?.data?.parent?.children, parentId:response?.data?.parent?._id});
