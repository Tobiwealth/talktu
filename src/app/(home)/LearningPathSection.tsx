...
export default function LearningPathSection() {
	...
	// 		setActiveTab((prevTab) => (prevTab + 1) % featureCategories.length);
	// 	}, 10000);
	...
	return (
		<section className="bg-white pt-[88px] pb-[155px] space-y-14 md:space-y-[76px]">
			<div className="container flex flex-col gap-2 px-4 text-center">
				<FadeUp className="min-[363px]:hidden">
				...
				<FadeUp className="items-center justify-center hidden gap-4 mt-8 md:flex">
