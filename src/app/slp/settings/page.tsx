			...
			<div className="bg-[#112349] rounded-[12px] py-4 px-4 md:px-8 flex flex-col gap-6 md:w-full lg:w-[90%] xl:w-[80%]">
				...
				<div className="flex flex-col gap-5 font-nunito">
					<div className="flex flex-col gap-2">
						<label className="text-base font-medium text-retro_blue-700" htmlFor="fullname">MRTB Certification Status</label>
						<input 
					...
					<div className="flex flex-col gap-2">
						<label className="text-base font-medium text-retro_blue-700" htmlFor="phoneNumber">MRTB Number</label>
						<input 
						    className="bg-[#15294F] border-[1px] border-[#2D4675] rounded-[12px] h-[3.125rem] placeholder:text-sm placeholder:text-neutral-500 px-4 text-retro_blue-700 focus:border-[2px] focus:outline-none focus:border-retro_blue-main" 
						    type="text"
						    placeholder="xy678925820890"
						    name="phoneNumber"
						/>
					</div>
					<div className="flex flex-col gap-2">
						<label className="text-base font-medium text-retro_blue-700" htmlFor="phoneNumber">Supporting document</label>
						<Image
							src={support_doc}
							width={266}
							height={189}
