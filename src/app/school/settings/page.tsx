...
const Settings = () => {
	return (
		<div className="flex flex-col w-full min-h-screen px-6 pb-16 pr-8 mt-8 lg:mt-28 md:px-8 lg:px-0 gap-6">
			<div className="bg-[#112349] rounded-[12px] py-4 px-4 md:px-8 flex flex-col gap-6 md:w-full lg:w-[90%] xl:w-[80%]">
				<h2 className="text-lg font-semibold text-white font-nunito md:text-xl lg:py-2">Subscription Details</h2>
				<div className="font-ninito font-medium text-sm text-retro_blue-700 flex flex-col gap-4 bg-[#1B3262] rounded-[14px] p-3 md:p-6">
					...
					<div className="flex md:gap-2">
					    ...
					    <p className="flex gap-1 md:gap-2 text-[8px] md:text-sm">
					        ...
					        <span className="flex items-center font-bold "><GoDotFill /><GoDotFill /><GoDotFill /><GoDotFill /></span>
					        <span className="flex items-center font-bold "><GoDotFill /><GoDotFill /><GoDotFill /><GoDotFill /></span> 
				...
				<div className="flex items-center justify-start pb-4 w-fit gap-4">
			...
			<div className="bg-[#112349] rounded-[12px] py-4 px-4 md:px-8 flex flex-col gap-6 md:w-full lg:w-[90%] xl:w-[80%]">
				<h2 className="text-xl font-semibold text-white font-nunito">Verification details</h2>
				<div className="flex flex-col gap-5 font-nunito">
					<div className="flex flex-col gap-2">
						<label className="text-base font-medium text-retro_blue-700" htmlFor="fullname">School Address</label>
						<input 
					...
					<div className="flex flex-col gap-2">
						<label className="text-base font-medium text-retro_blue-700" htmlFor="email">Official school email adress</label>
						<input 
						    className="bg-[#15294F] border-[1px] border-[#2D4675] rounded-[12px] h-[3.125rem] placeholder:text-sm placeholder:text-neutral-500 px-4 text-retro_blue-700 focus:border-[2px] focus:outline-none focus:border-retro_blue-main" 
						    type="email"
					...
					<div className="flex flex-col gap-2">
						<label className="text-base font-medium text-retro_blue-700" htmlFor="phoneNumber">Official school Phone number</label>
						<input 
						    className="bg-[#15294F] border-[1px] border-[#2D4675] rounded-[12px] h-[3.125rem] placeholder:text-sm placeholder:text-neutral-500 px-4 text-retro_blue-700 focus:border-[2px] focus:outline-none focus:border-retro_blue-main" 
						    type="text"
					...
					<div className="flex flex-col gap-2">
						<label className="text-base font-medium text-retro_blue-700" htmlFor="state">State</label>
						<input 
						    className="bg-[#15294F] border-[1px] border-[#2D4675] rounded-[12px] h-[3.125rem] placeholder:text-sm placeholder:text-neutral-500 px-4 text-retro_blue-700 focus:border-[2px] focus:outline-none focus:border-retro_blue-main" 
						    type="text"
						    placeholder="Lagos"
					...
					<div className="flex flex-col gap-2">
						<label className="text-base font-medium text-retro_blue-700" htmlFor="lga">LGA</label>
						<input 
						    className="bg-[#15294F] border-[1px] border-[#2D4675] rounded-[12px] h-[3.125rem] placeholder:text-sm placeholder:text-neutral-500 px-4 text-retro_blue-700 focus:border-[2px] focus:outline-none focus:border-retro_blue-main" 
						    type="text"
					...
					<div className="flex flex-col gap-2">
						<label className="text-base font-medium text-retro_blue-700" htmlFor="doc">Supporting document</label>
						<Image
							src={support_doc}
							width={266}
							height={189}
					...
					<div className="flex items-center justify-start pb-4 mt-2 w-fit gap-4">
