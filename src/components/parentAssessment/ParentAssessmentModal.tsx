...
const ParentAssessmentModal:React.FC<ModalProps> = ({setStartAssessment}) => {
	return (
		<div className="min-h-screen max-h-full py-24 bg-[#EEF3FE]">
			<div className="flex flex-col justify-center items-center w-full h-full p-8 md:p-32 ">
				<div className="flex flex-col justify-center items-center w-full lg:w-[533px] text-center gap-6 rounded-[24px] bg-white p-8 shadowbox2">
					...
					<p className="text-neutral-700 font-nunito font-medium text-sm md:text-base lg:text-lg">
					...
					<Button title="Start Assessment" onClick={() => setStartAssessment(true)} buttonClass="w-full h-[3.5rem]"/>
				</div>
			</div>
