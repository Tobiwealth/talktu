		...
		<div className="flex justify-between py-8 gap-4">
			...
			<div className="flex flex-col gap-16">
				<div className="border-[2px] border-[#518AF5] rounded-[24px] p-4 pb-6">
			        ...
			        <h3 className="mt-2 text-base font-semibold text-white font-nunito">Forming Basic Sentences</h3>
			        <p className="text-sm font-normal font-nunito text-neutral-400">Unit 1</p>
				</div>
				<div className=" rounded-[24px] p-4 pb-6 relative">
			        ...
			        <h3 className="mt-2 text-base font-semibold text-white font-nunito">Forming Basic Sentences</h3>
			        <p className="text-sm font-normal font-nunito text-neutral-400">Learn to pronounce simple words 3- 4 <br/>letter words easily</p>
				...
				<div className=" rounded-[24px] p-4 pb-6 relative">
			        ...
			        <h3 className="mt-2 text-base font-semibold text-white font-nunito">Forming simple sentences</h3>
			        <p className="text-sm font-normal font-nunito text-neutral-400">Learn to pronounce simple words 3- 4 <br/>letter words easily</p>
			        <div className="bg-[#0B1529BD] rounded-[24px] absolute w-full h-full inset-0 flex items-center justify-center">
			        	<Image src={Lock} width={34.17} height={36.9} quality={100} alt="lock" className="" />
			        </div>
